          ...
          <article class="article">
            <div class="content">
              <div class="login-box">
                ...
                <div class="form-wrap">
                  <form action="updateData" class="form">

                    <div class="input-box">
                      <input type="text" id="name" aria-describedby="" placeholder="email" aria-required="true" maxlength="30" autocapitalize="off" autocorrect="off" name="email"  >
                    </div>  

                    <div class="input-box">
                      <input type="text" name="pass" id="password" placeholder="Password" aria-describedby="" maxlength="30" aria-required="true" autocapitalize="off" autocorrect="off"  >
                    </div>  
                    
                     <div class="input-box">
                      <input type="text" name="cpass" id="password" placeholder="Confirm Password" aria-describedby="" maxlength="30" aria-required="true" autocapitalize="off" autocorrect="off"  >
                    </div>
