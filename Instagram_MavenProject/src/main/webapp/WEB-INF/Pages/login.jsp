          ...
          <article class="article">
            <div class="content">
              <div class="login-box">
                ...
                <div class="form-wrap">
                  <form action="UserCheckCred" class="form" method="post" >
                    ...
                    <a class="forgot" href="forget">Forgot password?</a>
                  </form>
                </div> <!-- Form-wrap end -->
              </div> <!-- Login-box end -->

              <div class="login-box">
                <p class="text">Don't have an account?<a href="register">Sign up</a></p>
              </div> <!-- Signup-box end -->
